	...
	<article class="tcard${opts.popular ? " tcard--popular" : ""}${completeClass}" data-tool="${esc(t.name)}">
		...
		<div class="tcard__head">
			...
			<div class="tcard__heading">
				<button class="tcard__title" type="button" data-tool="${esc(t.name)}" aria-label="Quick look: ${esc(t.title)}" style="${QUICK_VIEW_BUTTON_STYLE}"${dirAttrs(t.title)}>${esc(t.title)}</button>
