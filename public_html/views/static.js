	...
	return {
		...
		<div class="container page api-docs-page">
			...
			<div class="prose">
				...
				<ul>
					<li>${tWithElements("static.apiDocs.unifiedCommunityEndpoint", "{endpoint} is the product-facing ranked and paginated search. It accepts name, username, or tool text plus relationship, verification, activity, project, contributor, and ordering filters; each result states whether it is a person, an account-only match, or an unresolved attribution.", { endpoint: code("GET /v1/community/") })}</li>
