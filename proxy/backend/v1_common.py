...
from backend.v1_serializers import (
    author_key_payload,
    claim_payload,
    crawler_url_payload,
    health_target_payload,
    iso,
    list_payload,
    local_tool_is_public,
    media_payload,
    moderation_item,
    source_analysis_payload,
    sync_label,
    thanks_payload,
    tool_record_payload,
    with_common_meta,
...
def author_claim_owned_by(user: User) -> object:
...
def author_key_owned_by(user: User) -> object:
    """Match stable account ownership, with a narrow legacy username fallback."""
    return or_(
