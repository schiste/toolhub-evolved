...
from backend.v1_coverage import v1_coverage_bp
from backend.v1_crawler import v1_crawler_bp
from backend.v1_digests import v1_digests_bp
...
def register(app: Flask, *, db_url: str | None = None, secret_key: str | None = None) -> None:
    ...
    app.register_blueprint(v1_digests_bp)
    ...
    app.register_blueprint(v1_coverage_bp)
