...
def find_people(s: Session, query: str, *, limit: int = 50) -> list[dict[str, Any]]:
    ...
    return _people_directory.find_people(s, query, limit=limit)
...
def relationship_summaries_by_public_id(
    ...
    *,
    ...
    """Compatibility wrapper for public relationship summaries."""
    # Local imports avoid a module cycle with people_directory's shared helpers.
    from backend import (  # noqa: PLC0415
        people_directory as _people_directory,
    )

    return _people_directory.relationship_summaries_by_public_id(s, public_ids, checked_at=checked_at)
...
def search_people_directory(
    ...
    """Compatibility wrapper for the public people directory."""
    # Local imports avoid a module cycle with people_directory's shared helpers.
    from backend import (  # noqa: PLC0415
        people_directory as _people_directory,
    )

    return _people_directory.search_people_directory(s, search)
