...
const S = {
	page: `
		...
		<footer class="footer">
			<div class="footer__cols">
				<nav class="footer__col" aria-label="Discover">
					...
					<a href="/lists">Lists</a>
					<a href="/people?view=accounts">Accounts</a>
					...
					<nav class="footer__col" aria-label="Maintain">
						...
						<a href="/contribute">Help maintain Toolhub Evolved</a>
					</nav>
		...
		<figcaption class="sg-example__caption"><code>Feature banner + status tag</code><span>app chrome</span></figcaption>
	</figure>
			<figure class="sg-example sg-example--wide">
		...
		<p><a href="/contribute">Help maintain Toolhub Evolved</a> by improving listings or reporting gaps.</p>
	</article></div>
		...
		<div class="panel panel--cta">
			...
			<a class="btn btn--outline btn--md" href="/my-tools">My tools</a>
		</div>
	</div></div>
...
function expect(name, actual) {
	...
	if (BAKE) {
		fs.writeFileSync(`${SCRATCH}/styleguide__${name}.txt`, comparable);
		return;
	}
