...
def render(title: str, section: str, revision_range: str | None, commits: list[dict[str, object]]) -> str:
	range_label = revision_range or "repository history"
...
def write_outputs(
	...
	technical_output.write_text(
		render("Technical release notes", technical, revision_range, commits), encoding="utf-8"
	)
	user_output.write_text(render("What's new for users", user, revision_range, commits), encoding="utf-8")
